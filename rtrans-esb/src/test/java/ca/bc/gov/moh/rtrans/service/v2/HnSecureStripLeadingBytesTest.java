 ...
 */
public class HnSecureStripLeadingBytesTest {
      
    /**
     * Test of process method of class HnSecureStripLeadingBytes.
     */
    @Test
    public void testProcess() {

        String testMessage
                = "00000335MSH|^~\\&|PHSACERNERRAW|MOH_CRS|EMPI_BCHCIM|BCHCIM|20140625115359||QBP^Q21^QBP_Z21|164942|T|2.4\r"
                ...
                + "RCP|D|10^RD\r"
                + "PID|1||123456789^^^BC Provincial Id Number^NHN||||||||||||||||||||||0||||||N";
        ...
        HnSecureStripLeadingBytes instance = new HnSecureStripLeadingBytes();
        instance.process(exchange);
        
        //assertions
        assertEquals(exchange.getIn().getBody(), strippedMessage);
