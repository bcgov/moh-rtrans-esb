...
/**
 * VersionRoute class is added to provide the version information of deployed
 * artifacts This information can be retrieved from URL:
 * http://<hostname>:<port>/version
 * 
 */
public class VersionRoute extends RouteBuilder {
	...
	public void configure() throws Exception {
		from("jetty:http://{{minaListenerURI}}:{{port}}/version").routeId("rtrans-version")
				...
				.process(new PopulateVersionInformation()).log("RTrans sent a response with version information");
