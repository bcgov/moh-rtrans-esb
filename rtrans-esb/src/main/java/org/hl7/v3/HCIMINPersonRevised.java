 ...
 * &lt;complexType>
 *   &lt;complexContent>
 *     &lt;extension base="{urn:hl7-org:v3}PRPA_IN101204CA.MCCI_MT000100BC.Message">
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "")
@XmlRootElement(name = "HCIM_IN_PersonRevised")
public class HCIMINPersonRevised
        extends PRPAIN101204CAMCCIMT000100BCMessage implements RequestJaxbMessage {
    ...
    @XmlTransient
    private final static String DEFAULT_FC_REQUEST_EXTENSION = "HCIM_IN_PersonRevised";
    @XmlTransient
    ...
    @XmlTransient
    public final static String DEFAULT_BUSINESS_USE = "BUS";
    @XmlTransient
    ...
    @XmlTransient
    private final List<String> DEFAULT_REGISTRATION_EVENT_MOOD_CODE = Arrays.asList(new String[]{"RQO"});
    @XmlTransient
    ...
    @XmlTransient
    public final static String DEFAULT_PLAYED_OTHER_IDS_CLASS_CODE = "ROL";
    @XmlTransient
    public final static boolean DEFAULT_INTERACTION_DISPLAYABLE = true;
    
    public HCIMINPersonRevised() {
        populateDefaults();
    }
...
//        senderRepresentedOrganization.id.use = DEFAULT_BUSINESS_USE;
        ...
        // <controlActProcess>
        controlActProcess = new PRPAIN101204CAMFMIMT700701BCControlActProcess();
        ...
        controlActProcess.dataEnterer = new MFMIMT700701BCDataEnterer();
...
//        controlActProcess.dataEnterer.assignedPerson.id.use = DEFAULT_BUSINESS_USE;
        ...
        PRPAIN101204CAMFMIMT700701BCSubject subject = new PRPAIN101204CAMFMIMT700701BCSubject();
        controlActProcess.setSubject(subject);
        PRPAIN101204CAMFMIMT700701BCRegistrationEvent registrationEvent = new PRPAIN101204CAMFMIMT700701BCRegistrationEvent();
        ...
        PRPAIN101204CAMFMIMT700701BCSubject2 subject1 = new PRPAIN101204CAMFMIMT700701BCSubject2();
        registrationEvent.setSubject1(subject1);
        subject1.typeCode = DEFAULT_SUBJECT1_TYPECODE;
        PRPAMT101002BCIdentifiedPerson identifiedPerson = new PRPAMT101002BCIdentifiedPerson();
