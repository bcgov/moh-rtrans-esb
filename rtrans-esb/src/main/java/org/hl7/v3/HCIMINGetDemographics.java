 ...
 * &lt;complexType>
 *   &lt;complexContent>
 *     &lt;extension base="{urn:hl7-org:v3}PRPA_IN101101CA.MCCI_MT000100BC.Message">
 *     &lt;/extension>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "")
@XmlRootElement(name = "HCIM_IN_GetDemographics")
public class HCIMINGetDemographics
        extends PRPAIN101101CAMCCIMT000100BCMessage
    ...
    @XmlTransient
    private String DEFAULT_GD_REQUEST_EXTENSION = "HCIM_IN_GetDemographics";
    @XmlTransient
    ...
    private void populateDefaults() {
        ...
        interactionId.extension = DEFAULT_GD_REQUEST_EXTENSION;
        ...
        // <controlActProcess>
        controlActProcess = new PRPAIN101101CAQUQIMT020001BCControlActProcess();
        ...
        PRPAIN101101CAQUQIMT020001BCQueryByParameter processQueryByParameter = new PRPAIN101101CAQUQIMT020001BCQueryByParameter();
        controlActProcess.queryByParameter = objectFactory.createPRPAIN101101CAQUQIMT020001BCControlActProcessQueryByParameter(processQueryByParameter);
        processQueryByParameter.queryByParameterPayload = new QUPAMT101101BCQueryByParameterPayload();
